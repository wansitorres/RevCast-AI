...
def generate_explanation(data, forecast):
    ...
    1. Analyze the historical revenue data provided below and explain the trends, fluctuations, and patterns:
    {historical_data_str}
    
    2. Based on the historical data, explain the forecasted revenue values: {forecast_str}.
    
    3. Use the following context to enhance your forecast and explanation, but do not assume it is directly related to the user's input data:
    {context}
    """
...
# Home Page
if options == "Home":
    st.title("Welcome to the RevCast AI!")
    st.write("This application helps you predict future sales based on historical data, and provide actionable insights to help steer your business to success!")
    st.write("Use the sidebar to enter your OpenAI API key and navigate through the application.")
